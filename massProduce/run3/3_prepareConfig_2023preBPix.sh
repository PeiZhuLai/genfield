...
for ((iBin=0; iBin<$nMass; iBin++))
    ...
    cmsDriver.py Configuration/GenProduction/python/0_fragment_M${mass}.py \
        ...
        --fileout file:HZaTo2l2g_M${mass}_2023preBPix_sim_FRACTIONS.root \
        --number ${NEvents} \
        --number_out ${NEvents} \
        --no_exec \
        --mc
    ...
    cmsDriver.py  \
        ...
        --fileout file:HZaTo2l2g_M${mass}_2023preBPix_digi_FRACTIONS.root \
        ...
        --geometry DB:Extended \
        --filein file:HZaTo2l2g_M${mass}_2023preBPix_sim_FRACTIONS.root \
	    --datamix PreMix \
        --era Run3 \
        --no_exec \
        --mc \
    ...
    cmsDriver.py  \
        ...
        --fileout file:HZaTo2l2g_M${mass}_2023preBPix_AOD_FRACTIONS.root \
        --filein file:HZaTo2l2g_M${mass}_2023preBPix_digi_FRACTIONS.root \
        --number  ${NEvents} \
        --number_out  ${NEvents} \
        --no_exec \
        --mc 
    ...
    cmsDriver.py  \
        ...
        --fileout file:HZaTo2l2g_M${mass}_2023preBPix_MiniAODv4_FRACTIONS.root \
        --filein file:HZaTo2l2g_M${mass}_2023preBPix_AOD_FRACTIONS.root \
        --number ${NEvents} \
        --number_out ${NEvents} \
        --no_exec \
        --mc
    ...
    cmsDriver.py  \
        ...
        --fileout file:HZaTo2l2g_M${mass}_2023preBPix-Run3Summer22NanoAODv12-00005_FRACTIONS.root \
        --filein file:HZaTo2l2g_M${mass}_2023preBPix_MiniAODv4_FRACTIONS.root \
        --number ${NEvents} \
        --number_out ${NEvents} \
        --no_exec \
        --mc 

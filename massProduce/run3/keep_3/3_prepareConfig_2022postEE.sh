...
for ((iBin=0; iBin<$nMass; iBin++))
    ...
    cmsDriver.py Configuration/GenProduction/python/HIG-Run3Summer22wmLHEGS-00026-fragment_M${mass}.py \
        ...
        --fileout file:$outpath/HZaTo2l2g_M${mass}_2022postEE-Run3Summer22wmLHEGS-00026_FRACTIONS.root \
        --number ${NEvents} \
        --number_out ${NEvents} \
        --no_exec \
        --mc
    ...
    cmsDriver.py  \
        ...
        --fileout file:$outpath/HZaTo2l2g_M${mass}_2022postEE-Run3Summer22DRPremix-00013_0_FRACTIONS.root \
        ...
        --geometry DB:Extended \
        --filein file:$outpath/HZaTo2l2g_M${mass}_2022postEE-Run3Summer22wmLHEGS-00026_FRACTIONS.root \
	    --datamix PreMix \
        --era Run3 \
        --runUnscheduled \
        --no_exec \
    ...
    cmsDriver.py  \
        ...
        --fileout file:$outpath/HZaTo2l2g_M${mass}_2022postEE-Run3Summer22DRPremix-00013_FRACTIONS.root \
        --filein file:$outpath/HZaTo2l2g_M${mass}_2022postEE-Run3Summer22DRPremix-00013_0_FRACTIONS.root \
        --number  ${NEvents} \
        --number_out  ${NEvents} \
        --no_exec \
        --mc 
    ...
    cmsDriver.py  \
        ...
        --fileout file:$outpath/HZaTo2l2g_M${mass}_2022postEE-Run3Summer22MiniAODv4-00005_FRACTIONS.root \
        --filein file:$outpath/HZaTo2l2g_M${mass}_2022postEE-Run3Summer22DRPremix-00013_FRACTIONS.root \
        --number ${NEvents} \
        --number_out ${NEvents} \
        --no_exec \
        --mc
    ...
    cmsDriver.py  \
        ...
        --fileout file:$outpath/HZaTo2l2g_M${mass}_2022postEE-Run3Summer22NanoAODv12-00005_FRACTIONS.root \
        --filein file:$outpath/HZaTo2l2g_M${mass}_2022postEE-Run3Summer22MiniAODv4-00005_FRACTIONS.root \
        --number ${NEvents} \
        --number_out ${NEvents} \
        --no_exec \
        --mc 

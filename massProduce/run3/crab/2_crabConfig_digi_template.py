...
config.JobType.psetName = f'{cmsswBase}/HZaTo2l2g_M{mass}/2_digi_fragment_{era}_FRACTIONS.py'
config.JobType.numCores = 1

config.section_('Data')
# config.Data.inputDataset = open(f"{DASFileBase}/DAS_Names_{era}_M{mass}.txt").read()

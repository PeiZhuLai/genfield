...
for era in "${eraList[@]}"; do
  for mA in "${massList[@]}"; do
    ...
    LOG_FILE="/afs/cern.ch/work/p/pelai/HZa/gridpacks/genfield/massProduce/run3/crab_${era}/HZaTo2l2g_miniAOD_M${mA}/crab_HZa_miniAOD_${era}_M${mA}/crab.log"
    ...
    dasgoclient -query="file dataset=${DATASET_PATH} instance=prod/phys03" > "./DAS_fileLists/miniAOD/miniAOD_files_${era}_M${mA}.txt"
